$(document).ready(function () {
	$('.slider').slick({
		...
		//https://www.youtube.com/watch?v=rXNfDfqtM3M&list=PLM6XATa8CAG6IJvQBkrTTNZmpIcyS2Avk&index=9
		arrows: true, // стрелки
		dots: true, // точки
		...
		verticalSwiping: false, // вертикальный свайп для вертикального слайдера (false) (Для корректной работы кужно указать слайду высоту)
		...
		//todo data-lazy <img data-lazy="@img/01.jpg" alt=""> для ленивой подгрузки
...
//? Если слайдер внутри флекс элемента или он сам флекс элемент, то для флекс элемента нужно указать
//.slider{
//	min-width:0;
//}
...
//align-iitems: flex-start	// Включить для адаптивной высоты (adaptiveHeight: true)
//}
